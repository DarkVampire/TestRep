========================================================================
    ПРИЛОЖЕНИЕ : Обзор проекта ВМ_Лаб1_Интерполяция
========================================================================

Это приложение ВМ_Лаб1_Интерполяция создано автоматически с помощью мастера 
приложений.  

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения ВМ_Лаб1_Интерполяция.

ВМ_Лаб1_Интерполяция.vcxproj
...
ВМ_Лаб1_Интерполяция.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем ВМ_Лаб1_Интерполяция.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
